		...
		resolveRes := fn.MapOptionZ(
			...
			func(a AuxContractResolver) fn.Result[tlv.Blob] {
				return a.ResolveContract(ResolutionReq{
					...
					CltvDelay:     fn.Some(htlc.RefundTimeout),          //nolint:lll
		...
		func(a AuxContractResolver) fn.Result[tlv.Blob] {
			return a.ResolveContract(ResolutionReq{
				...
				AuxSigDesc: fn.Some(AuxSigDesc{
					...
					AuxSig: func() []byte {
						auxHtlcSigType := htlcCustomSigType.TypeVal()     //nolint:lll
						return htlc.CustomRecords[uint64(auxHtlcSigType)] //nolint:lll
					}(),
				}),
			})
		},
